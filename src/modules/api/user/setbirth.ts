...
export default class extends ApiAction {
  ...
  public paramCheck() {
    ...
    ) throw new ErrorCode(1234, "date is invalid")
  }
  ...
  public async execute() {
    if (Config.modules.user.setBirthOnlyOnce) {
      ...
      if (date.birth_day != null || date.birth_month != null) throw new ErrorCode(1234, `date of birth is already set and it can not be changed`)
    }
