...
export default class extends MainAction {
  ...
  public async execute() {
    ...
    if (typeof this.params.rank != "undefined") {
      ...
      let pos = await this.connection.first(`SELECT FIND_IN_SET(event_point, (SELECT GROUP_CONCAT(event_point ORDER BY event_point DESC) FROM event_ranking WHERE event_id=:event)) as rank FROM event_ranking WHERE event_id=:event HAVING rank < :r`, {
        r: this.params.rank,
        event: this.params.event_id
      })
